...
class MainApp(MDApp, ScreenManager, BoxLayout, Screen10):
    ...
    def on_start(self):
        try:
            ...
            print("No Internet Connection! - MAIN")
            exit()
    ...
    def get_weather(self, city_name):
        try:
            ...
            if x["cod"] != "404":
                ...
                screen4.ids.temperature.text = f"[b]{temperature}[/b]°"
                ...
                screen4.ids.location.text = location
                if id == "800":
                    screen6.ids.weather_image.source = "images/sun.png"
                    screen4.ids.weather_image.source = "images/sun.png"
                elif "200" <= id <= "232":
                    screen6.ids.weather_image.source = "images/storm.png"
                    screen4.ids.weather_image.source = "images/storm.png"
